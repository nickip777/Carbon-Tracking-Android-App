...
/**
 * a pie graph for four week mode version
 */


public class FourWeekModePieGraph extends AppCompatActivity {
    private Singleton singleton= Singleton.getInstance();
    private CustomDate daySelected;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_four_week_mode_pie_graph);
    ...
    private void setupChart() throws ParseException {
        ...
        //animate
        PieChart chart = (PieChart) findViewById(R.id.FourWeekModePie);
        chart.setData(data);
        chart.animateY(1000);
        chart.invalidate();
    }
