...
/**
 *   select the end day for 365 days carbon consume graph
 */
public class SelectDayForYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_day_for_year);
        showDialogDate();
    ...
    private void showDialogDate(){
        TextView textView = (TextView) findViewById(R.id.textViewSelectDayForYear);
    ...
    private void populateDateFromField() {
        ...
        Intent intent = new Intent(getApplicationContext(), SelectGraphModeYear.class);
