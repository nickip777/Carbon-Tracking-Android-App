...
public class SelectDay extends AppCompatActivity {
    ...
    private void showDialogDate(){
        TextView textView = (TextView) findViewById(R.id.textViewSelectDay);
    ...
    private void populateDateFromField() {
        ...
        Intent intent = new Intent(getApplicationContext(), SelectGraphModeOneDay.class);
