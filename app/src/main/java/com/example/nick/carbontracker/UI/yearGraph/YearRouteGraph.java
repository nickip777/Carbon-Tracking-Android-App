...
/**
 * show a pie graph of year carbon emission, route version.
 */
public class YearRouteGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year_route_graph);
...
//METHODS FOR ACTION BAR******************************************************************
    ...
    private void setupChart() throws ParseException {
        ...
        List<DailyUtilityBill> monthCost = singleton.getUsageDailyBills(daySelected, 365);
        ...
        int startDate = CustomDate.toJulian(daySelected.getYear(),daySelected
                .getMonth(),daySelected.getDay())-365;
        ...
        for(int i = 0; i < singleton.getUserRoutes().size();i++) {
        ...
        //animate
        PieChart chart = (PieChart) findViewById(R.id.OneYearRoute);
        chart.setData(data);
        chart.animateY(1000);
        chart.invalidate();
    }
